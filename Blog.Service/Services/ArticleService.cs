...
namespace Blog.Service.Services
{
    public class ArticleService : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdUser)
        {
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedUser)
        {
        ...
        public async Task<IResult> Delete(int articleId, string modifiedUser)
        {
